<template>
  <div class="user">
    ...
    <el-table :data="list" border tooltip-effect="dark" style="width: 100%">
      ...
      <el-table-column prop="cardNo" label="证件号码" min-width="70" align="center" />
      <el-table-column prop="positiveLink" label="证件正面" min-width="150" align="center">
        <template slot-scope="row">
          <img :src="row.row.positiveLink" style="width: 150px;" alt="">
        </template>
      </el-table-column>
      <el-table-column prop="sideLink" label="证件反面" min-width="150" align="center">
        <template slot-scope="row">
          <img :src="row.row.sideLink" style="width: 150px;" alt="">
        </template>
      </el-table-column>
      <el-table-column prop="handLink" label="手持证件" min-width="150" align="center">
        <template slot-scope="row">
          <img :src="row.row.handLink" style="width: 150px;" alt="">
        </template>
      </el-table-column>
      <el-table-column prop="welMember" label="邀请人ID" min-width="70" align="center">
      </el-table-column>
...
export default {
  ...
  methods: {
    getList() {
      ...
      this.$http
        .get("/admin/adminMember/getMembers", this.listQuery)
        .then((res) => {
