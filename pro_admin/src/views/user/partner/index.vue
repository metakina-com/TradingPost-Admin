...
export default {
  ...
  methods: {
    getList() {
      ...
      this.$http
        .get("/admin/adminMember/getWelMembers", this.listQuery)
        .then((res) => {
    ...
    setMemberAdmin(id) {
      ...
      data.sonMember = id;
      this.$http.post("/admin/adminMember/setMemberAdmin", data).then((res) => {
        this.$message({
          message: "操作成功",
          type: "success",
        });
    ...
    cancelMemberAdmin(id) {
      ...
      data.sonMember = id;
      this.$http
        .post("/admin/adminMember/setMemberAdminFalse", data)
        .then((res) => {
    ...
    setMemberPower() {
      ...
      this.$http
        .post("/admin/adminMember/setMemberPower", data)
        .then((res) => {
          console.log(res);
          if (res.status == "SUCCEED") {
            this.$message({
