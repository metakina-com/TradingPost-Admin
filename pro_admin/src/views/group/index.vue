    ...
    <el-row :gutter="20">
      <el-col :span="8" :xs="24" style="margin-bottom: 5px"
        ><div class="grid-content bg-purple">
          <h3>注册总人数 {{ data.sumMemberCount }}</h3>
          <h5>今日注册人数 {{ data.todayMemberCount }}</h5>
          <h5>昨日注册人数 {{ data.yesTodayMemberCount }}</h5>
        </div></el-col
      >
      <el-col :span="8" :xs="24" style="margin-bottom: 5px"
        ><div class="grid-content bg-purple">
          <h3>今日手续费 {{ data.todaySumFee }}</h3>
          <h5>昨日总手续费 {{ data.yesYodaySumFee }}</h5>
        </div></el-col
      >
      <el-col :span="8" :xs="24" style="margin-bottom: 5px"
        ><div class="grid-content bg-purple">
          <h3>今日交易人数 {{ data.todayTradeCount }}</h3>
          <h5>昨日交易人数 {{ data.yesTradeCount }}</h5>
        </div></el-col
      >
    </el-row>
    <div>
