<template>
  <div class="user">
    ...
    <el-table :data="list" border tooltip-effect="dark" style="width: 100%">
      ...
      <el-table-column prop="createTime" label="用户类型" min-width="70" align="center" show-overflow-tooltip>
      </el-table-column>
      ...
      <el-table-column prop="mainCur" label="币种" min-width="70" align="center" show-overflow-tooltip></el-table-column>
      <el-table-column prop="matchTime" label="开仓时间" min-width="70" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="isContractHands" label="开仓张数" min-width="70" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="avePrice" label="开仓均价" min-width="70" align="center" show-overflow-tooltip>
      </el-table-column>
...
export default {
  ...
  methods: {
    getList() {
      ...
      this.$http
        .get("/admin/adminMember/getCreateOrders", this.listQuery)
        .then((res) => {
